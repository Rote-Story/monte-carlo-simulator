...
class TestFetchMarketData(unittest.TestCase):
    ...
    def test_fetch_market_data_valid_input(self):
        ...
        with patch("yfinance.download") as mock_download:
            ...
            result = self.test_market_data_fetcher.fetch_market_data(self.ticker_symbol)
    ...
    def test_fetch_market_data_ticker_get_info_called_once(self, _):
        self.test_market_data_fetcher.fetch_market_data(self.ticker_symbol)
        self.mock_ticker_instance.get_info.assert_called_once()
    
    @patch("yfinance.download")
    def test_fetch_market_data_generic_http_error_message(self, _):
    ...
    @patch("yfinance.download")
    def test_fetch_market_data_request_exception_message(self, _):
    ...
    @patch("yfinance.download")
    def test_fetch_market_data_general_exception_message(self, _):
