...
class TestRunBacktest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_backtest_vis_observer = Mock(spec=BacktestVisFrame)
        ...
        self.sim_patcher['backtest_vis'].return_value = Mock(spec=plt.Figure)
        ...
        self.simulator_subject.attach(self.mock_backtest_vis_observer)
        self.simulator_subject.attach(self.mock_observer)

    def tearDown(self):
        patch.stopall()
        
    def test_run_backtest_sim_figure_is_plt_figure(self):
        self.simulator_subject.run_backtest(
        ...
        self.assertIsInstance(self.simulator_subject.backtest_figure, plt.Figure)

    def test_run_backtest_error_message_is_none(self):
        self.simulator_subject.run_backtest(
            asset_symbol=self.asset_symbol,
            market_symbol=self.market_symbol,
            rfr_symbol=self.rfr_symbol,
    ...
    def test_run_backtest_error_message_output(self):
    ...
    def test_run_backtest_short_time_period_error_message(self):
    ...
    def test_run_backtest_calc_volatility_called_once(self):
        self.simulator_subject.run_backtest(
            asset_symbol=self.asset_symbol,
            market_symbol=self.market_symbol,
            rfr_symbol=self.rfr_symbol,
    ...
    def test_run_backtest_backtest_vis_called_once(self):
        self.simulator_subject.run_backtest(
            asset_symbol=self.asset_symbol,
            market_symbol=self.market_symbol,
            rfr_symbol=self.rfr_symbol,
        ...
        self.sim_patcher['backtest_vis'].assert_called_once()

    def test_run_backtest_expected_returns_method_called_once(self):
            self.simulator_subject.run_backtest(
                asset_symbol=self.asset_symbol,
                market_symbol=self.market_symbol,
                rfr_symbol=self.rfr_symbol,
    ...
    def test_run_backtest_price_col_checker_called_once(self):
            self.simulator_subject.run_backtest(
                asset_symbol=self.asset_symbol,
                market_symbol=self.market_symbol,
                rfr_symbol=self.rfr_symbol,
    ...
    def test_run_backtest_update_called_once(self):
            self.simulator_subject.run_backtest(
                asset_symbol=self.asset_symbol,
                market_symbol=self.market_symbol,
                rfr_symbol=self.rfr_symbol,
            ...
            self.mock_backtest_vis_observer.update.assert_called_with(self.simulator_subject)
    
    def test_run_backtest_monte_carlo_sim_called_once(self):
        self.simulator_subject.run_backtest(
            asset_symbol=self.asset_symbol,
            market_symbol=self.market_symbol,
            rfr_symbol=self.rfr_symbol,
    ...
    def test_run_backtest_populate_data_called_once(self):
